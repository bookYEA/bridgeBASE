...
export function getBridgeEncoder(): Encoder<BridgeArgs> {
...
export function getBridgeDecoder(): Decoder<Bridge> {
...
export function getBridgeCodec(): Codec<BridgeArgs, Bridge> {
