...
export function getEip1559Encoder(): Encoder<Eip1559Args> {
...
export function getEip1559Decoder(): Decoder<Eip1559> {
...
export function getEip1559Codec(): Codec<Eip1559Args, Eip1559> {
