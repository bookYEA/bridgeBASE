...
export function getBridgeCallBufferedInstructionDataEncoder(): Encoder<BridgeCallBufferedInstructionDataArgs> {
...
export function getBridgeCallBufferedInstructionDataDecoder(): Decoder<BridgeCallBufferedInstructionData> {
  return getStructDecoder([
    ['discriminator', fixDecoderSize(getBytesDecoder(), 8)],
  ]);
}

export function getBridgeCallBufferedInstructionDataCodec(): Codec<
