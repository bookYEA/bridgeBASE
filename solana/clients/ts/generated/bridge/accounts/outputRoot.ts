...
export function getOutputRootEncoder(): Encoder<OutputRootArgs> {
...
export function getOutputRootDecoder(): Decoder<OutputRoot> {
...
export function getOutputRootCodec(): Codec<OutputRootArgs, OutputRoot> {
