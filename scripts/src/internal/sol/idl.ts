...
export const IDL = {
  ...
  instructions: [
    {
      ...
      discriminator: [113, 115, 232, 194, 248, 32, 39, 21],
      accounts: [
        {
          name: "owner",
          docs: [
    ...
    },
    {
      ...
      discriminator: [90, 23, 83, 238, 200, 18, 111, 95],
      accounts: [
        {
          name: "payer",
          docs: [
    ...
    },
    {
      ...
      discriminator: [138, 112, 52, 204, 33, 68, 62, 85],
      accounts: [
        {
          name: "payer",
          docs: [
    ...
    },
    {
      ...
      discriminator: [190, 190, 32, 158, 75, 153, 32, 86],
      accounts: [
        {
          name: "payer",
          docs: [
    ...
    },
    {
      ...
      discriminator: [52, 106, 74, 190, 246, 31, 157, 12],
      accounts: [
        {
          name: "payer",
          docs: [
    ...
    },
    {
      ...
      discriminator: [87, 109, 172, 103, 8, 187, 223, 126],
      accounts: [
        {
          name: "payer",
          docs: [
    ...
    },
    {
      ...
      discriminator: [86, 187, 229, 4, 110, 8, 116, 153],
      accounts: [
        {
          name: "payer",
          docs: [
    ...
    },
    {
      ...
      discriminator: [55, 201, 139, 188, 226, 16, 136, 143],
      accounts: [
        {
          name: "payer",
          docs: [
    ...
    },
    {
      ...
      discriminator: [117, 175, 150, 237, 216, 76, 56, 5],
      accounts: [
        {
          name: "payer",
          docs: [
    ...
    },
    {
      ...
      discriminator: [132, 188, 7, 198, 64, 178, 62, 29],
      accounts: [
        {
          name: "owner",
          docs: [
        ...
        {
          name: "call_buffer",
          docs: ["The call buffer account to close"],
          writable: true,
        },
      ],
      args: [],
    ...
    },
    {
      ...
      discriminator: [85, 68, 100, 234, 255, 226, 95, 72],
      accounts: [
        {
          name: "payer",
          docs: [
        ...
        {
          name: "system_program",
          docs: ["System program required for creating new accounts"],
        },
      ],
      args: [
        {
    ...
    },
    {
      ...
      discriminator: [172, 66, 78, 136, 158, 187, 47, 115],
      accounts: [
        {
          name: "payer",
          docs: [
    ...
    },
    {
      ...
      discriminator: [215, 66, 12, 154, 4, 123, 196, 66],
      accounts: [
        {
          name: "payer",
          docs: [
    ...
    },
    {
      ...
      discriminator: [187, 90, 182, 138, 51, 248, 175, 98],
      accounts: [
        {
          name: "message",
          docs: [
    ...
    },
    {
      ...
      discriminator: [31, 91, 190, 63, 164, 7, 31, 150],
      accounts: [
        {
          name: "bridge",
          docs: ["The bridge account containing configuration"],
          writable: true,
        },
        {
          name: "guardian",
          docs: ["The guardian account authorized to update configuration"],
          signer: true,
        },
      ],
      args: [
    ...
    },
    {
      ...
      discriminator: [76, 70, 237, 100, 33, 108, 19, 42],
      accounts: [
        {
          name: "bridge",
          docs: ["The bridge account containing configuration"],
    ...
    },
    {
      ...
      discriminator: [148, 146, 101, 170, 5, 6, 222, 119],
      accounts: [
        {
          name: "bridge",
          docs: ["The bridge account containing configuration"],
    ...
    },
    {
      ...
      discriminator: [198, 111, 160, 55, 172, 138, 99, 164],
      accounts: [
        {
          name: "bridge",
          docs: ["The bridge account containing configuration"],
    ...
    },
    {
      ...
      discriminator: [58, 188, 230, 188, 47, 188, 79, 154],
      accounts: [
        {
          name: "bridge",
          docs: ["The bridge account containing configuration"],
    ...
    },
    {
      ...
      discriminator: [164, 95, 213, 130, 26, 69, 82, 127],
      accounts: [
        {
          name: "bridge",
          docs: ["The bridge account containing configuration"],
    ...
    },
    {
      ...
      discriminator: [132, 25, 19, 13, 118, 63, 167, 102],
      accounts: [
        {
          name: "bridge",
          docs: ["The bridge account containing configuration"],
    ...
    },
    {
      ...
      discriminator: [140, 178, 4, 238, 245, 66, 117, 189],
      accounts: [
        {
          name: "bridge",
          docs: ["The bridge account containing configuration"],
    ...
    },
    {
      ...
      discriminator: [56, 95, 58, 94, 221, 136, 138, 156],
      accounts: [
        {
          name: "bridge",
          docs: ["The bridge account containing configuration"],
    ...
    },
    {
      ...
      discriminator: [38, 183, 212, 67, 28, 241, 25, 160],
      accounts: [
        {
          name: "bridge",
          docs: ["The bridge account containing configuration"],
    ...
    },
    {
      ...
      discriminator: [34, 48, 231, 135, 42, 113, 217, 157],
      accounts: [
        {
          name: "bridge",
          docs: ["The bridge account containing configuration"],
    ...
    },
    {
      ...
      discriminator: [118, 25, 145, 217, 114, 209, 236, 145],
      accounts: [
        {
          name: "bridge",
          docs: ["The bridge account containing configuration"],
    ...
    },
    {
      ...
      discriminator: [229, 2, 41, 119, 55, 255, 252, 205],
      accounts: [
        {
          name: "bridge",
          docs: ["The bridge account containing configuration"],
    ...
    },
    {
      ...
      discriminator: [118, 250, 162, 85, 197, 130, 116, 123],
      accounts: [
        {
          name: "bridge",
          docs: ["The bridge account containing configuration"],
    ...
    },
    {
      ...
      discriminator: [203, 83, 204, 83, 225, 109, 44, 6],
      accounts: [
        {
          name: "payer",
          docs: [
  ...
  accounts: [
    {
      name: "Bridge",
      discriminator: [231, 232, 31, 98, 110, 3, 23, 59],
    },
    {
      name: "CallBuffer",
      discriminator: [134, 143, 168, 251, 163, 216, 180, 113],
    },
    {
      name: "IncomingMessage",
      discriminator: [30, 144, 125, 111, 211, 223, 91, 170],
    },
    {
      name: "OutgoingMessage",
      discriminator: [150, 255, 197, 226, 200, 215, 31, 29],
    },
    {
      name: "OutputRoot",
      discriminator: [11, 31, 168, 201, 229, 8, 180, 198],
    },
  ],
  errors: [
    {
  ...
  types: [
    {
      ...
      type: {
        ...
        fields: [
          {
            name: "threshold",
            docs: ["Number of required valid unique signatures"],
            type: "u8",
          },
          {
            name: "signer_count",
            docs: ["Number of signers in `signers` array"],
            type: "u8",
          },
          {
            name: "signers",
            docs: ["Static list of authorized signer addresses"],
            type: {
              array: [
                {
                  array: ["u8", 20],
    ...
    },
    {
      ...
      type: {
        ...
        fields: [
          ...
          {
            name: "nonce",
            docs: ["Incremental nonce assigned to each outgoing message."],
            type: "u64",
          },
          {
            name: "guardian",
          ...
          {
            name: "paused",
            docs: ["Whether the bridge is paused (emergency stop mechanism)"],
            type: "bool",
          },
          {
            name: "eip1559",
            docs: ["EIP-1559 state and configuration for dynamic pricing."],
            type: {
              defined: {
                name: "Eip1559",
              },
          ...
          {
            name: "gas_config",
            docs: ["Configuration parameters for outgoing message pricing"],
            type: {
              defined: {
                name: "GasConfig",
              },
          ...
          },
          {
            ...
            docs: ["Configuration parameters for bridge protocol"],
            type: {
              defined: {
                name: "ProtocolConfig",
              },
          ...
          },
          {
            ...
            docs: ["Configuration parameters for Base oracle signers"],
            type: {
              defined: {
                name: "BaseOracleConfig",
              },
    ...
    },
    {
      ...
      type: {
        ...
        fields: [
          ...
          {
            name: "value",
            docs: ["Amount of ETH to send with this call on Base, in wei."],
            type: "u128",
          },
          {
            name: "data",
    ...
    },
    {
      ...
      type: {
        ...
        fields: [
          {
            name: "owner",
            docs: ["The owner who can modify this call buffer"],
            type: "pubkey",
          },
          {
            name: "ty",
      ...
      type: {
        ...
        fields: [
          ...
          },
          {
            ...
            docs: ["Gas used in the current time window (runtime state)"],
            type: "u64",
          },
          {
    ...
    },
    {
      ...
      type: {
        ...
        fields: [
          {
            name: "target",
            docs: ["Gas target per window"],
            type: "u64",
          },
          {
            name: "denominator",
            docs: ["Adjustment denominator (controls rate of change)"],
            type: "u64",
          },
          {
            name: "window_duration_seconds",
            docs: ["Window duration in seconds"],
            type: "u64",
          },
          {
      ...
      type: {
        ...
        fields: [
          ...
          },
          {
            ...
            docs: ["Decimal precision for the gas cost scaler (denominator)"],
            type: "u64",
          },
          {
            name: "gas_fee_receiver",
            docs: ["Account that receives gas fees collected on Solana"],
            type: "pubkey",
          },
          {
            name: "gas_per_call",
            docs: ["Amount of gas per Solana --> Base message"],
            type: "u64",
          },
        ],
      },
    ...
    },
    {
      ...
      type: {
        ...
        fields: [
          {
            name: "program_id",
            docs: ["Program that will process this instruction."],
            type: "pubkey",
          },
          {
            name: "accounts",
            docs: ["Accounts required for this instruction."],
            type: {
              vec: {
                defined: {
                  name: "IxAccount",
    ...
    },
    {
      ...
      type: {
        ...
        fields: [
          {
            name: "pubkey",
            docs: ["Public key of the account."],
            type: "pubkey",
          },
          {
            name: "is_writable",
            docs: ["Whether the account is writable."],
            type: "bool",
          },
          {
            name: "is_signer",
            docs: ["Whether the account is a signer."],
            type: "bool",
          },
        ],
      },
    ...
    },
    {
      ...
      type: {
        ...
        fields: [
          ...
          {
            name: "symbol",
            docs: ['The symbol/ticker of the token (e.g., "WBTC")'],
            type: "string",
          },
          {
            name: "remote_token",
  ...
  constants: [
    {
      ...
      type: "bytes",
      value:
        "[98, 114, 105, 100, 103, 101, 95, 99, 112, 105, 95, 97, 117, 116, 104, 111, 114, 105, 116, 121]",
    },
    {
      name: "BRIDGE_SEED",
      type: "bytes",
    ...
    },
    {
      ...
      type: "bytes",
      value:
        "[105, 110, 99, 111, 109, 105, 110, 103, 95, 109, 101, 115, 115, 97, 103, 101]",
    },
    {
